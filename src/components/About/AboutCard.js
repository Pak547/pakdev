      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />
            <br />
            As you explore my <a href="https://www.linkedin.com/in/pakapong-mongkol/" >LinkedIn</a>, my portfolio, or GitHub, you'll notice a consistent theme, "passion". A passion that not only propelled me through a rigorous Full Stack MERN boot camp but also empowered me to take on freelancing roles for local businesses, crafting websites that serve as a testament to my dedication to technology and scalable web applications.
            <br />
            <br />
